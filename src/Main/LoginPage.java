...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\arpid\\OneDrive\\Documents\\MSIS\\Sem 1\\AED\\FinalProject\\login2.jpeg")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/trial_with_jdbcconnector","root","root");
            int ID = Integer.parseInt(id.getText());
            String NAME = name.getText();
            String USERNAME = username.getText();
            String PASSWORD = password.getText();

            PreparedStatement pst = con.prepareStatement("insert into user(Id,Name,Username,Passwords)values(?,?,?,?)");
            pst.setInt(1,ID);
